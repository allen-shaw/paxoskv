...
func (c *paxosKVClient) Prepare(ctx context.Context, in *PrepareReq, opts ...grpc.CallOption) (*PrepareResp, error) {
	out := new(PrepareResp)
...
func (c *paxosKVClient) Accept(ctx context.Context, in *AcceptReq, opts ...grpc.CallOption) (*AcceptResp, error) {
	out := new(AcceptResp)
...
func (UnimplementedPaxosKVServer) Prepare(context.Context, *PrepareReq) (*PrepareResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Prepare not implemented")
}
func (UnimplementedPaxosKVServer) Accept(context.Context, *AcceptReq) (*AcceptResp, error) {
